...
lastmod: '2025-08-30'
authors: ['default']
tags: ['</>', 'AI Efficiency', 'Developer Tools', 'LLMs', 'MLOps', 'RAG']
draft: false
...
LangChain is a popular open-source framework for LLM apps, and we’ll use it together with ChromaDB, an AI-native vector database. For a broader understanding of how such frameworks contribute to the development of intelligent, decision-making AI, read my article on [AI Agents and Autonomous Systems](./ai-agents-and-autonomous-systems). This article walks through loading product data, indexing it in Chroma, and using an LLM to answer questions. By the end, we will have designed a functioning “product knowledge bot” that can answer questions about the iPhone 16 from up-to-date information.
